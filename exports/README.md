...
| Claude Code | `exports/claude-code/skills/safe-refactoring.md`             | spell.safe-refactoring.v1                | spell://safe-refactoring/517A86095D                |
...
| Claude Code | `exports/claude-code/skills/bug-diagnosis-from-logs.md`      | spell.bug-diagnosis-from-logs.v1         | spell://bug-diagnosis-from-logs/2BC4379FD0         |
...
| Claude Code | `exports/claude-code/skills/api-design.md`                   | spell.api-design.v1                      | spell://api-design/828C8A1237                      |
...
| Claude Code | `exports/claude-code/skills/migration-without-data-loss.md`  | spell.migration-without-data-loss.v1     | spell://migration-without-data-loss/AD15B25ECB     |
...
| Claude Code | `exports/claude-code/skills/test-generation.md`              | spell.test-generation.v1                 | spell://test-generation/16A7DCF9E2                 |
...
| Claude Code | `exports/claude-code/skills/performance-tuning.md`           | spell.performance-tuning.v1              | spell://performance-tuning/75981D9E3F              |
...
| Claude Code | `exports/claude-code/skills/jailbreak-resilience-review.md`  | spell.jailbreak-resilience-review.v1     | spell://jailbreak-resilience-review/36B797783D     |
