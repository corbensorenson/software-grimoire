...
| ----------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| field-spell-evaluations | Weak-vs-repaired field spell benchmark across six software tasks.                    | safe-refactoring executable fixture; planted ground-truth checks; forbidden-pattern checks | Current project-owned evidence uses one surface.; Some outcomes remain text-judgment checks.            | No private code, credentials, or destructive commands. |
| jailbreak-resilience    | Defensive prompt-injection and jailbreak-resilience behavior with harmless canaries. | canary leak checks; forbidden string checks; fixture file presence                         | No live external jailbreak corpus in default build.; Tool calls are not yet mediated by a real harness. | Defanged fixtures only; no operational bypass prompts. |
