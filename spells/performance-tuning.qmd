...
Raw template: [prompts/spells/performance-tuning.txt](../prompts/spells/performance-tuning.txt)
...
- [Proof by Difference Case](../examples/weak-vs-repaired/performance-tuning.qmd)
- [Recorded Evaluations](../examples/evaluations/performance-tuning.qmd)
