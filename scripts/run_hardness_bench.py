...
def run_artifact(case_slug: str, variant: str) -> dict:
    ...
    artifact = ROOT / "examples" / "evaluations" / "hardness-v4" / "artifacts" / case_slug / variant / case["artifact"]
    ...
    with tempfile.TemporaryDirectory(prefix="grimoire-hardness-v4-", dir=SCRATCH_DIR) as raw_tmp:
        ...
        shutil.copy2(artifact, sandbox / case["artifact"])
                ...
                runs.append(
                    {
                        ...
                        "artifact_path": f"examples/evaluations/hardness-v4/artifacts/{case_slug}/{variant}/{case['artifact']}",
